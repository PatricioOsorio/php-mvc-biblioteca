...
<div class="card card-body bg-light mt-5">
  <form action="<?php echo RUTA_URL ?>prestamos/agregar" method="POST" class="row">
    ...
    <div class="form-group col-md-6 mb-3">
      ...
      <input type="datetime-local" class="form-control" name="fecha_prestamo" id="fecha_prestamo" required>
    </div>
    <div class="form-group col-md-6 mb-3">
      <label class="form-label" for="fecha_regreso">Fecha regreso</label>
      <input type="datetime-local" class="form-control" value="today" name="fecha_regreso" id="fecha_regreso" required>
    </div>
